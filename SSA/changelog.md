...
| June 11, 2015 | Ella | Revision | SSATestMultiSims | Master | Added calculations for means and variances using a set number of points, instead of a time period. Testing indicates that "steps" are producing more consistent results than time intervals. Intervals of 1% of all steps/ total time is producing consistent results. | Testing for 10,000 + number of simulations. Adding an additional species (4 species, 4 reactions) | 
